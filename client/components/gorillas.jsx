    ...
    return (
      <section className="gorillas row">
        ...
        <div className="one-half column right">
          ...
          <p>To learn more, checkout the award winning documentary Virunga on Netflix or visit the Gearing Up for Gorillas website at<a href="http://www.g4g.co.uk" target="_blank">G4G.co.uk</a></p>
          <figure>
